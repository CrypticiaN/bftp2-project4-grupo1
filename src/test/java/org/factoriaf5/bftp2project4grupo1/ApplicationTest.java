...
class ApplicationTests {
    ...
    void returnsGamesFromAGivenCategory() throws Exception {
        ...
        Game softwareGame = gameRepository.save(new Game("Wii Sports", "X360", 2002, "https://www.lavanguardia.com/files/image_449_220/uploads/2020/09/12/5faa727a54ec2.png", "action", "12", "non realistic violence"));
