...
public class SampleDataLoader {
    ...
    public void loadSampleData() {
        gameRepository.saveAll(List.of(
                new Game("Wii Sports","Wii",2006,"https://www.gamulator.com/img/roms/wii-sports-nintendo-wii-cover-340x483.jpg"),
                ...
                new Game("Pokemon Red/Pokemon Blue", "GB", 1996, "https://www.gamulator.com/img/roms/pokemon-red-blue-2-in-1-gb-cover-340x483.jpg"),
                new Game("Nintendogs", "DS", 2005, "https://www.gamulator.com/img/roms/nintendogs-dalmatian-friends-cover-nds-eu-340x483.jpg")
        ));
    }
}
